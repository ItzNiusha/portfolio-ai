//shoutout to https://codepen.io/RunicFreak/pen/poYWXJJ
...
const useFluidCursor = () => {
  ...
  let config = {
    ...
    VELOCITY_DISSIPATION: 0.2, // changed from 0.4
    PRESSURE: 0.29, // changed from 0.12
    PRESSURE_ITERATIONS: 20,
    CURL: 0, // changed from 40
    SPLAT_RADIUS: 0.22, // changed from 0.25
    SPLAT_FORCE: 6000,
    SHADING: true,
